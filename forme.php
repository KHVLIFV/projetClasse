...
<body>
    ...
    <label for="matiere">Matière: </label><br>
        <label for="francais">
        &emsp;<input type="checkbox" name="matiere" id="francais" value="francais">Français
        </label>
        <label for="francais">
            <input type="checkbox" name="matiere" id="compression" value="compression de donnees">Compression de données
        </label>
        <label for="francais">
            <input type="checkbox" name="matiere" id="crypto" value="cryptographie">Cryptographie
        </label>
    </form>
</body>
</html>